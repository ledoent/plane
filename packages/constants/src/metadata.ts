...
export const SITE_NAME = "Measurement Instruments — Project Tracker";
export const SITE_TITLE = "Measurement Instruments — Project Tracker";
export const SITE_DESCRIPTION =
  "Work items, roadmaps and delivery tracking for Measurement Instruments and DuroPC.";
export const SITE_KEYWORDS =
  "Measurement Instruments, DuroPC, industrial computers, project management, work items tracking";
export const SITE_URL = "https://plane.ledoweb.com/";
export const TWITTER_USER_NAME = "Measurement Instruments — Project Tracker";
