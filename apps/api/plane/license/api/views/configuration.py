...
class EmailCredentialCheckEndpoint(BaseAPIView):
    def post(self, request):
        ...
        subject = "Email Notification from Measurement Instruments"
        message = "This is a sample email notification sent from the Measurement Instruments Plane instance."
        # Send the email
        try:
